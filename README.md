...
This repo contains the smart contract used in the Nodys project.
...
```
brownie run scripts/01_deploy_data_types.py
brownie run scripts/02_upgrade_data_types.py
brownie run scripts/03_deploy_personal_data.py
```

This will:

1. Deploy a `DataTypes` implementation contract
